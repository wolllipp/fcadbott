...
export const api = {
  ...
  events: {
    ...
    create: (data: { name: string; eventDate: string; description?: string; coordinatorId: number; role?: string; location?: string; status?: string; pointsForAttendance?: number; pointsForOrganization?: number; maxParticipants?: number; audience?: string; facultyOnly?: boolean; requireApproval?: boolean; scannerCoordinatorId?: number; scannerCoordinatorIds?: number[]; studentScannerIds?: number[]; organizerStudentIds?: number[] }) => apiRequest('/events', { method: 'POST', body: JSON.stringify(data) }),
    update: (id: number, data: { name?: string; eventDate?: string; description?: string; coordinatorId: number; role?: string; location?: string; status?: string; pointsForAttendance?: number; pointsForOrganization?: number; maxParticipants?: number; audience?: string; facultyOnly?: boolean; requireApproval?: boolean; scannerCoordinatorId?: number | null; scannerCoordinatorIds?: number[]; studentScannerIds?: number[]; organizerStudentIds?: number[] }) => apiRequest(`/events/${id}`, { method: 'PUT', body: JSON.stringify(data) }),
