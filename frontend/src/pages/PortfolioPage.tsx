...
export default function PortfolioPage() {
  ...
  return (
    <div className="landing-page">
      ...
      <main id="top">
        <section className="landing-hero"><div><h1>ФКП БГУИР</h1><p>Факультет компьютерного проектирования — место, где технологии, студенческая инициатива и люди собираются в одну живую систему.</p><div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 10, marginBottom: 18 }}><a className="landing-button" href="https://t.me/fcad_ss_bot" target="_blank" rel="noopener" style={{ fontSize: 15, padding: '12px 22px' }}>Стать ближе к ФКП</a></div><div className="landing-actions"><a className="landing-button" href="#admission" onClick={(e) => { e.preventDefault(); scrollToSection('admission'); }}>Поступившим — важно</a></div></div></section>
